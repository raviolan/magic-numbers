    ...
    components.html(
        "\n".join(
            [
                ...
                ".pitch-output-table { width: 100%; border-collapse: collapse; table-layout: fixed; background: #ffffff; }",
                ".pitch-output-table th, .pitch-output-table td { border: 1px solid rgba(59, 56, 33, 0.22); padding: 0.55rem 0.65rem; text-align: left; vertical-align: top; }",
                ".pitch-output-table th { font-weight: 700; }",
                ".pitch-output-table th:first-child, .pitch-output-table td:first-child { width: 36%; }",
